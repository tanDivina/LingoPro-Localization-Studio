  ...
  return (
    <div className="space-y-8 transition-colors duration-300">
      <div className="bg-white dark:bg-slate-900 p-8 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-brand-md flex flex-col md:flex-row items-center space-y-6 md:space-y-0 md:space-x-12">
        <div className="w-full md:w-1/3 h-48 bg-slate-50 dark:bg-slate-950 border-2 border-dashed border-slate-200 dark:border-slate-800 rounded-3xl flex flex-col items-center justify-center text-center group transition-all hover:border-indigo-400 relative overflow-hidden">
          ...
          <div className="relative z-0 space-y-3">
             <i className="ph-bold ph-upload-simple text-5xl text-slate-300 group-hover:text-indigo-400 transition-colors"></i>
        ...
        <div className="flex-1 space-y-6">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <span className="px-4 py-2 bg-indigo-50 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-400 text-[9px] font-black rounded-lg border border-indigo-100 dark:border-indigo-800 uppercase tracking-widest">Diarization v2</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-brand-sm overflow-hidden min-h-[500px] flex flex-col">
        <div className="p-6 sm:p-8 bg-slate-50/50 dark:bg-slate-800/30 border-b border-slate-200 dark:border-slate-800 flex flex-col sm:flex-row justify-between sm:items-center gap-4">
          ...
          <button className="h-[44px] px-6 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-indigo-600 dark:text-indigo-400 text-[10px] font-black uppercase tracking-[0.2em] rounded-xl hover:shadow-brand-md transition-all flex items-center justify-center">Export Results</button>
        </div>
                  ...
                  <div className="flex-1 pb-2">
                    <div className="flex items-center space-x-4 mb-4">
                       <input 
                         ...
                         className="bg-indigo-50/50 dark:bg-indigo-900/20 text-indigo-700 dark:text-indigo-400 text-[10px] font-black uppercase tracking-widest h-[40px] px-4 rounded-xl border border-transparent focus:border-indigo-400 focus:bg-white transition-all w-44 shadow-brand-sm min-h-[44px]"
                       />
                       <datalist id="speakers-list">{knownSpeakers.map(name => <option key={name} value={name} />)}</datalist>
                       <div className="h-px flex-1 bg-slate-100 dark:bg-slate-800 group-hover:bg-indigo-100 transition-colors"></div>
                    </div>
